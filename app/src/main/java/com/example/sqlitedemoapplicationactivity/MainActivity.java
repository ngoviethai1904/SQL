...
public class MainActivity extends AppCompatActivity {
    ...
    public void  updateStudent(View view){
        ...
        boolean result = dataHandler.updateDataHandler(Integer.parseInt(studentid.getText().toString()),studentname.getText().toString());
        if (result){
            studentid.setText("");
            studentname.setText("");
    ...
    public void findFirstStudent(View view){
        DataHandler dbHandler = new DataHandler(this,null,null,1);{
            Student student = dbHandler.findFisrtDataHandler(studentname.getText().toString());
            if (student != null){
                datalist.setText(String.valueOf(student.getStudentID()) + "" + student.getStudentName() + System.getProperty("line.separator"));
                studentid.setText("");
                studentname.setText("");
            }
            else {
    ...
    public void findAllStudent(View view){
        DataHandler dataHandler = new DataHandler(this,null,null,1);
        List<Student> lst = dataHandler.findAllDataHandler(studentname.getText().toString());
        String studentsList = "";
        if (!lst.isEmpty()){
            for (Student st:lst){
    ...
    public void deleteStudent(View view){
        DataHandler dataHandler = new DataHandler(this  ,null,null,1);
       boolean result = dataHandler.deleteDataHandler(Integer.parseInt(studentid.getText().toString()));
        if (result) {
            studentid.setText("");
            studentname.setText("");
